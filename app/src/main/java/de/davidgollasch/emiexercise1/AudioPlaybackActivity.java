...
public class AudioPlaybackActivity extends AppCompatActivity {
    ...
    private void ConfigureSoundEffects(int sessionID) {
        ...
        //bassBoost.setEnabled(true); //deaktiviert, da "unpassend"
        //tbtnBassBoost.setChecked(true); //deaktiviert, da "unpassend"

        // VIRTUALIZER
        virtualizer = new Virtualizer(0, sessionID);
        virtualizer.setStrength((short) 1000);
        //virtualizer.setEnabled(true);        //deaktiviert, da "unpassend"
        //tbtnVirtualizer.setChecked(true);    //deaktiviert, da "unpassend"
    }
